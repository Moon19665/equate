    ...
    <section className="w-full px-4 py-10 md:py-16 bg-white">
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start justify-center gap-8 md:gap-0">
        ...
        <div className="flex-1 flex flex-col items-center px-4 mb-8 md:mb-0">
          {/* ai icon */}
          <span className="mb-3 text-gray-400 text-xl font-mono">a<span className="text-gray-400">i</span></span>
          <h3 className="font-semibold text-gray-900 text-lg mb-2">Easy to use.</h3>
          <p className="text-gray-600 text-sm text-center">
            Make expenses a breeze for every employee with a beautiful mobile app powered by Brex AI.
          </p>
        </div>
        {/* Greater control */}
        <div className="flex-1 flex flex-col items-center px-4 mb-8 md:mb-0">
          ...
          <span className="mb-3">
            <svg width="32" height="32" fill="none" viewBox="0 0 32 32">
              <circle cx="16" cy="16" r="12" stroke="#bdbdbd" strokeWidth="2" fill="none"/>
        ...
        <div className="flex-1 flex flex-col items-center px-4">
          ...
          <span className="mb-3">
            <svg width="28" height="32" fill="none" viewBox="0 0 28 32">
              <rect x="4" y="2" width="20" height="28" rx="4" stroke="#bdbdbd" strokeWidth="2"/>
              <rect x="10" y="26" width="8" height="2" rx="1" fill="#bdbdbd"/>
            </svg>
          </span>
      ...
      <div className="max-w-3xl mx-auto mt-14 md:mt-20 text-center">
        <div className="mb-5 flex justify-center">
          <img
            src="https://brand.brex.com/transform/8b3c1c68-9760-4dc4-872c-15010b7d016b/Superhuman-Logo?io=transform:fit,width:2000,height:253&quality=95"
            alt="Superhuman Logo"
        ...
        <blockquote className="text-gray-900 italic text-lg md:text-xl font-normal leading-relaxed mb-4">
          “Brex is both a really flexible budgeting and card provisioning management tool and our expense report tool. It’s a clean setup.”
        </blockquote>
