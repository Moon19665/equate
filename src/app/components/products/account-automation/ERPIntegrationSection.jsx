          ...
          <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                ...
                , and more using custom rules and field entries and automated general ledger coding.
              </p>
            ...
            <div className="w-full lg:w-1/2">
              ...
              <ul className="space-y-4 text-gray-700 text-base">
                ...
                <li className="flex items-start gap-2">
                  ...
                  Automate GL coding and merchant mapping with{" "}
                  <a href="#" className="text-blue-600 underline hover:text-blue-800 transition-colors">AI-generated suggestions</a>.
                </li>
              </ul>
            </div>
          </div>
  
          {/* Multi-Entity Accounting Section */}
          <div className="mt-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            {/* Content Column */}
            <div className="w-full lg:w-1/2">
