  ...
  return (
    ...
    <div className="w-full bg-[#0a1013] py-16 px-4">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center">
          <div className="relative w-full max-w-md rounded-2xl overflow-hidden shadow-2xl bg-[#0a233b] p-0">
            <img
              src="https://brand.brex.com/transform/e4595ed1-c6db-480f-9417-8c50ad6b1761/AI-Spmgmt?io=transform:fit,width:2000,height:1915&quality=95"
              alt="Brex Assistant"
        ...
        <div className="w-full flex flex-col items-start lg:items-start">
          ...
          <p className="text-base md:text-lg text-[#bfc6ce] mb-7 max-w-xl">
      ...
      <div className="max-w-7xl mx-auto mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="w-full flex flex-col items-center">
          <img
            src="https://brand.brex.com/transform/1c6e3174-3dd7-4492-b2b7-4173ef17bac9/Spend-management-Budget?io=transform:fit,width:2000,height:2024&quality=95"
            alt="Live Budgets"
            className="w-full max-w-md rounded-2xl shadow-xl mb-6 object-contain"
            draggable={false}
          />
          <div className="w-full flex flex-col items-center mt-2">
            <span className="uppercase text-xs tracking-widest text-[#bfc6ce] mb-2">Superhuman</span>
            <blockquote className="text-[#bfc6ce] text-lg md:text-xl italic text-center mb-1 max-w-md">
              “The more that's in Brex budgets, the more control we have across every kind of spend.”
            </blockquote>
            <span className="text-[#bfc6ce] text-sm text-center">
    ...
    <div className="w-full bg-[#0a1013] py-16 px-4">
      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center mb-12">
        <img
          src="https://brand.brex.com/transform/46a50afd-04be-421b-bf9a-49cfa22ee953/SeatGeek-White?io=transform:fit,width:2000,height:1405&quality=95"
          alt="SeatGeek Logo"
          className="h-12 mb-3"
          style={{ filter: 'brightness(0) invert(1)' }}
        />
        <blockquote className="text-white text-2xl md:text-3xl font-light mb-3 leading-snug">
        ...
        <a href="#" className="text-[#ff6600] font-semibold text-base hover:underline mt-2">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-12 mb-12">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center">
          <img
            src="https://brand.brex.com/transform/f845185a-c1de-488b-be66-1b27af3d5d73/Month-end?io=transform:fit,width:2000,height:2007&quality=95"
